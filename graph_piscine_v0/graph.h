...
class Graph
{
    private :
        ...
        std::map<int,std::string> m_regime;
    ...
    public:
        ...
        void set_regime(int a, std::string b) { m_regime.insert(std::pair<int,std::string>(a,b)); }

        void charger_fichier(std::string b);
