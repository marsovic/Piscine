...
class Vertex
{
    ...
    public:
        ...
        void set_color(int num) { m_num_color = num; }
        int get_color() { return m_num_color; }
};
...
class Graph
{
    ...
    public:
        ...
        void sauvegarder_graphe(std::string fichier);
        void changer_graphe();
        void ajouter_sommet(int idx);
        void supprimer_sommet(int idx);

        void set_idx_ver_max(int value) { m_idx_ver_max = value; }
        void set_idx_edge_max(int value) { m_idx_edge_max = value; }
        void set_id(std::string value) { m_identifiant = value; }
        int get_idx_ver_max() { return m_idx_ver_max; }
        int get_idx_edge_max() { return m_idx_edge_max; }
        std::string get_id() { return m_identifiant; }

        ///Méthodes pour la forte connexité des graphes
        void reset_color();
        int sommet_non_colories();
        void colorier_sommets();
        void chercher_forte_connexite();
